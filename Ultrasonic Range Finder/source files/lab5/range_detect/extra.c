...
int32_t my_filter_im[] = { 0, INT16_MAX * 0.587785, INT16_MAX * -0.951057, INT16_MAX
                               * 0.951057,
                       INT16_MAX * -0.587785, 0 };
int32_t my_filter_re[] = { INT16_MAX, INT16_MAX * -0.809017, INT16_MAX * 0.309017,
                       INT16_MAX * 0.309017, INT16_MAX * -0.809017, INT16_MAX };
#endif

#if SAMPLE_RATE == 160000
int32_t my_filter_re[] = { INT16_MAX, 0, -INT16_MAX, 0, INT16_MAX, 0, -INT16_MAX, 0 };
int32_t my_filter_im[] = { 0, INT16_MAX, 0, -INT16_MAX, 0, INT16_MAX, 0, -INT16_MAX };
#endif
